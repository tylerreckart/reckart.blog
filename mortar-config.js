...
const config = {
  ...
  siteConfig: {
    ...
    intro:
      "<span role='img' aria-label='waving hand'>👋</span> Hi, I'm Tyler. I'm a software developer based in Greenville, SC working at <a class='alley' href='https://alley.co' target='_blank' rel='noreferrer'>Alley</a>. You can see my code on <a class='github' href='https://github.com/tylerreckart' target='_blank' rel='noreferrer'>Github</a>, view my photos on <a class='instagram' href='https://instagram.com/tylerreckart' target='_blank' rel='noreferrer'>Instagram</a>, or read more <a href='/about'>about me</a> if you'd like.",
  },
  seoConfig: {
    title: "Tyler Reckart",
